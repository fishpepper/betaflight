...
TEST(OsdTest, TestAlarms)
{
    ...
    osdConfigMutable()->item[OSD_RSSI_VALUE] = (osdItem_t) {   8,  1, OSD_ORIGIN_NW, OSD_ITEM_VISIBLE};
    osdConfigMutable()->item[OSD_MAIN_BATT_VOLTAGE] = (osdItem_t) {   12,  1, OSD_ORIGIN_NW, OSD_ITEM_VISIBLE};
    osdConfigMutable()->item[OSD_ITEM_TIMER_1] = (osdItem_t) {  20,  1, OSD_ORIGIN_NW, OSD_ITEM_VISIBLE};
    osdConfigMutable()->item[OSD_ITEM_TIMER_2] = (osdItem_t) {   1,  1, OSD_ORIGIN_NW, OSD_ITEM_VISIBLE};
    osdConfigMutable()->item[OSD_ALTITUDE] = (osdItem_t) {   23,  7, OSD_ORIGIN_NW, OSD_ITEM_VISIBLE};
